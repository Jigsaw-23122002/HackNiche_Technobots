  ...
  return (
   <>
    <div class="bg-purple-100">
      <nav class="px-2 bg-purple-100 border-gray-200 dark:bg-green-900 dark:border-gray-700">
      <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a href="#" class="flex items-center">
          <img src="https://img.icons8.com/stickers/1x/blockchain-new-logo.png" class="h-6 mr-3 sm:h-10" alt="Flowbite Logo" />
          <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Team Chainers</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
          <ul class="flex  bg-purple-100 flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
    ...
    <img class="rounded-full w-96 h-96" src="https://nanonets.com/blog/content/images/2022/06/shutterstock_1785042593.jpg" alt="image description"/>
